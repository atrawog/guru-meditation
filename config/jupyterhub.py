...
c.JupyterHub.bind_url = 'http://:8010'
c.Spawner.notebook_dir = '/workspace'
c.JupyterHub.cookie_secret_file = '/workspace/.jupyter/jupyterhub_cookie.secret'
...
c.Spawner.args = [
    '--NotebookApp.cookie_secret_file=/workspace/.jupyter/jupyterhub_cookie.secret'
]
c.LabApp.disable_check_for_updates = True
# Set the path for the SQLite database
c.JupyterHub.db_url = 'sqlite:////workspace/.jupyter/jupyterhub.sqlite'

# Set the path for the proxy PID file
c.ConfigurableHTTPProxy.pid_file = '/workspace/.jupyter/jupyterhub-proxy.pid'
